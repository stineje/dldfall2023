...
\subsubsection{Power, Performance and Area}
...
digital logic represents.  However, there is a good chance that many
of these items will not look similar.  This is because Xilinx Vivado
...
You should report in your final report your final PPA for your
design.  For this lab and the remainder of your laboratories, you will
only report Performance and Area.  Power is more difficult to assess
and for now we will defer this to later courses.  Once your design is
implemented, you can click on the Reports Tab.
