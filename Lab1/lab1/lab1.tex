...
\begin{figure} [tb]
\begin{center}
\includegraphics[scale=1.5]{f05-05-9780128000564.eps}
\end{center}
\caption{Generalized Ripple-Carry Adder (RCA) Implementation~\cite{ddca-riscv}.}
\label{rca.fig}
\end{figure}
...
There is an excellent journal that discusses information on this too
